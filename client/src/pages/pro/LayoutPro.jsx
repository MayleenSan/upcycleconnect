...
import { LayoutDashboard, Package, Archive, CreditCard, Bell, LogOut } from 'lucide-react'
import { useAuth } from '../../context/AuthContext'

const nav = [
  { label: 'Tableau de bord', chemin: '/pro', icone: LayoutDashboard },
  { label: 'Annonces', chemin: '/pro/annonces', icone: Package },
  { label: 'Conteneurs', chemin: '/pro/conteneurs', icone: Archive },
  { label: 'Mon abonnement', chemin: '/pro/abonnement', icone: CreditCard },
  { label: 'Notifications', chemin: '/pro/notifications', icone: Bell },
]
    ...
    <div className="min-h-screen bg-[#F8F4EE] flex">
      <aside className="hidden md:flex flex-col w-60 bg-white border-r border-gray-100 fixed h-full">
        <div className="p-5 border-b border-gray-100">
          ...
          <span className="text-xs text-gray-400 font-medium">Espace professionnel</span>
        </div>
